...
<head>
    @php
        $seoSite   = trim($pengaturan['nama_perpustakaan'] ?? 'Sistem Informasi Perpustakaan');
        $seoSchool = trim($pengaturan['nama_sekolah'] ?? 'Perpustakaan Sekolah');
        $seoHome   = url('/');
    ...
    <script defer src="{{ asset('vendor/aos/aos.js') }}"></script>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="space-y-3 md:col-span-2">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <span class="text-sm font-black text-white block">{{ $pengaturan['nama_perpustakaan'] ?? 'Sistem Informasi Perpustakaan' }}</span>
                            <span class="text-[10px] text-gray-400 font-bold uppercase">{{ $pengaturan['nama_sekolah'] ?? 'Perpustakaan Sekolah' }}</span>
                        </div>
                    </div>
