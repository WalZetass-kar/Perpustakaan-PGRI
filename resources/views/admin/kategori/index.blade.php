...
<div class="space-y-6" x-data="{ openAddModal: false }">
    ...
    <div class="flex items-center justify-between">
        <h2 class="text-base font-bold text-gray-900">Daftar Kategori Buku</h2>
        ...
        <table class="w-full text-left border-collapse text-xs">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-100 text-gray-500 uppercase tracking-wider">
                    ...
                    <th class="py-3 px-5 font-semibold">Slug</th>
        ...
        <div class="bg-white rounded-xl max-w-md w-full p-6 space-y-4 shadow-xl border border-gray-200" @click.away="openAddModal = false">
            ...
            <form action="{{ route('admin.kategori.store') }}" method="POST" class="space-y-3 text-xs">
                ...
                <div>
                    ...
                    <input type="text" name="nama" required placeholder="Contoh: Matematika & Sains" class="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-700">
                </div>
                <div>
