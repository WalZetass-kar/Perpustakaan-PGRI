            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div class="space-y-1 sm:col-span-2">
                    ...
                    <input type="text" name="nama_perpustakaan" value="{{ old('nama_perpustakaan', $pengaturan['nama_perpustakaan'] ?? 'Perpustakaan SMK PGRI Pekanbaru') }}" required
                           placeholder="Contoh: Perpustakaan SMK PGRI Pekanbaru (Inlislite)"
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="nama_sekolah" value="{{ old('nama_sekolah', $pengaturan['nama_sekolah'] ?? 'SMK PGRI Pekanbaru') }}"
                           placeholder="Contoh: SMK PGRI Pekanbaru"
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="npsn" value="{{ old('npsn', $pengaturan['npsn'] ?? '10404456') }}"
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="kepala_perpustakaan" value="{{ old('kepala_perpustakaan', $pengaturan['kepala_perpustakaan'] ?? 'Dra. Hj. Nurhayati, M.Pd') }}"
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="nip_kepala_perpustakaan" value="{{ old('nip_kepala_perpustakaan', $pengaturan['nip_kepala_perpustakaan'] ?? '19750812 200212 2 003') }}"
        ...
        <div x-show="activeTab === 'kontak'" x-cloak class="bg-white rounded-2xl border-2 border-gray-200 shadow-sm p-6 sm:p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div class="space-y-1 sm:col-span-2">
                    ...
                    <textarea name="alamat" rows="2" placeholder="Contoh: Jl. Pendidikan No. 45, Gedung Utama Lt. 2 Perpustakaan SMK PGRI Pekanbaru."
                              class="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl focus:ring-1.5 focus:ring-brand-700 focus:bg-white focus:outline-none font-medium">{{ old('alamat', $pengaturan['alamat'] ?? 'Jl. Pendidikan No. 45, Gedung Utama Perpustakaan SMK PGRI Pekanbaru.') }}</textarea>
                </div>

                <div class="space-y-1">
                    <label class="block font-bold text-gray-800">Email Resmi Layanan</label>
                    <input type="email" name="email_perpustakaan" value="{{ old('email_perpustakaan', $pengaturan['email_perpustakaan'] ?? 'perpustakaan@smkpgri.sch.id') }}"
                           placeholder="Contoh: perpustakaan@smkpgri.sch.id"
                           class="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl focus:ring-1.5 focus:ring-brand-700 focus:bg-white focus:outline-none font-medium">
                </div>

                <div class="space-y-1">
                    <label class="block font-bold text-gray-800">Nomor Telepon / WhatsApp Layanan</label>
                    <input type="text" name="telepon" value="{{ old('telepon', $pengaturan['telepon'] ?? '(0761) 7890-1234') }}"
                           placeholder="Contoh: (0761) 7890-1234 / 0812-7890-1234"
                           class="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl focus:ring-1.5 focus:ring-brand-700 focus:bg-white focus:outline-none font-medium">
                </div>

                <div class="space-y-1 sm:col-span-2">
                    <label class="block font-bold text-gray-800">Website Resmi Sekolah</label>
                    <input type="text" name="website_sekolah" value="{{ old('website_sekolah', $pengaturan['website_sekolah'] ?? 'https://smkpgripekanbaru.sch.id') }}"
                           placeholder="Contoh: https://smkpgripekanbaru.sch.id"
                           class="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl focus:ring-1.5 focus:ring-brand-700 focus:bg-white focus:outline-none font-mono">
                </div>
            </div>
        </div>
        ...
        <div x-show="activeTab === 'sirkulasi'" x-cloak class="bg-white rounded-2xl border-2 border-gray-200 shadow-sm p-6 sm:p-8 space-y-6">
            <div class="border-b border-gray-100 pb-3 flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-gray-500">Kebijakan sirkulasi fisik buku (Same-day circulation tanpa denda)</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div class="space-y-1 bg-gray-50 p-4 rounded-xl border border-gray-200">
                    ...
                    <p class="text-[10.5px] text-gray-500 mb-2">Peminjaman dan pengembalian di hari yang sama</p>
                    <div class="flex items-center gap-2">
                        <input type="number" name="durasi_pinjam_hari" value="{{ old('durasi_pinjam_hari', $pengaturan['durasi_pinjam_hari'] ?? 1) }}" required min="1" max="30"
                               class="w-24 px-3 py-1.5 bg-white border border-gray-300 rounded-lg focus:ring-1.5 focus:ring-brand-700 font-mono font-bold text-sm">
                        <span class="font-bold text-gray-700">Hari (Same-Day Loan)</span>
                    </div>
                </div>
                ...
                <div class="space-y-1 sm:col-span-2">
                    ...
                    <textarea name="pesan_sirkulasi" rows="2" placeholder="Pesan petunjuk yang ditampilkan di halaman detail buku untuk siswa..."
                              class="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl focus:ring-1.5 focus:ring-brand-700 focus:bg-white focus:outline-none font-medium">{{ old('pesan_sirkulasi', $pengaturan['pesan_sirkulasi'] ?? 'Untuk meminjam buku fisik ini, silakan datangi meja pengelola perpustakaan di Ruang Perpustakaan SMK PGRI Pekanbaru. Buku dipinjam dan dikembalikan pada hari yang sama.') }}</textarea>
                </div>

                <div class="space-y-1 sm:col-span-2">
                    <label class="block font-bold text-gray-800">Ketentuan & Syarat Peminjam</label>
                    <input type="text" name="syarat_peminjaman" value="{{ old('syarat_peminjaman', $pengaturan['syarat_peminjaman'] ?? 'Siswa aktif SMK PGRI Pekanbaru dengan menyebutkan nama lengkap & kelas.') }}"
                           placeholder="Contoh: Siswa aktif SMK PGRI Pekanbaru dengan menyebutkan nama lengkap & kelas."
                           class="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl focus:ring-1.5 focus:ring-brand-700 focus:bg-white focus:outline-none font-medium">
                </div>
            </div>
        </div>
        ...
        <div x-show="activeTab === 'tampilan'" x-cloak class="bg-white rounded-2xl border-2 border-gray-200 shadow-sm p-6 sm:p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div class="space-y-1 sm:col-span-2">
                    ...
                    <input type="text" name="judul_hero" value="{{ old('judul_hero', $pengaturan['judul_hero'] ?? 'Perpustakaan SMK PGRI Pekanbaru (Inlislite)') }}"
                           placeholder="Contoh: Perpustakaan SMK PGRI Pekanbaru (Inlislite)"
                ...
                <div class="space-y-1 sm:col-span-2">
                    ...
                    <textarea name="subjudul_hero" rows="2" placeholder="Deskripsi ringkas yang tampil di bawah judul hero..."
                              class="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl focus:ring-1.5 focus:ring-brand-700 focus:bg-white focus:outline-none font-medium">{{ old('subjudul_hero', $pengaturan['subjudul_hero'] ?? 'Sebuah Perpustakaan Digital Sekolah yang dikembangkan langsung untuk menghimpun koleksi kejuruan, referensi modul, dan pelayanan perpustakaan dalam bentuk digital.') }}</textarea>
                </div>
        ...
        <div x-show="activeTab === 'server'" x-cloak class="bg-white rounded-2xl border-2 border-gray-200 shadow-sm p-6 sm:p-8 space-y-6">
            <div class="border-b border-gray-100 pb-3 flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-[11px] text-gray-500">Status lingkungan server perpustakaan dan ringkasan database</p>
                </div>
            </div>
