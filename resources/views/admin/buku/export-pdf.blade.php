...
<body>
    ...
    <div class="no-print-bar">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <span style="font-size: 12px; color: #64748b; font-weight: 600;">| Pratinjau Dokumen Cetak / PDF</span>
        </div>
        <div style="display: flex; align-items: center; gap: 10px;">
    ...
    <div class="paper-page">
        <div class="header-kop">
            <div class="kop-text">
                ...
                <p>Telepon: {{ $pengaturan['telepon'] ?? '(0761) 23456' }} | Website / Email: {{ $pengaturan['email_perpustakaan'] ?? 'perpustakaan@smkpgri-pku.sch.id' }}</p>
            </div>
        </div>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 220px; text-align: left;">Judul Buku</th>
                    ...
                    <th style="width: 45px;">Thn</th>
                    <th style="width: 95px; text-align: left;">Kategori</th>
                    <th style="width: 100px; text-align: left;">Lokasi Rak &amp; Laci</th>
                    <th style="width: 45px;">Total</th>
                    <th style="width: 45px;">Ada</th>
            ...
            <tbody>
                @forelse($bukuItems as $idx => $buku)
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; font-family: monospace; font-size: 8pt;">{{ $buku->isbn ?? '-' }}</td>
                        <td>{{ $buku->penulis->nama ?? '-' }}</td>
                        <td>{{ $buku->penerbit->nama ?? '-' }}</td>
                        <td style="text-align: center;">{{ $buku->tahun_terbit ?? '-' }}</td>
                        <td>{{ $buku->kategori->nama ?? 'Umum' }}</td>
                        <td>
                            <strong style="color: #881337;">{{ $rakName }}</strong> ({{ $laciName }})
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="11" style="text-align: center; padding: 20px; color: #94a3b8;">Tidak ada data buku yang terdaftar di sistem.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
