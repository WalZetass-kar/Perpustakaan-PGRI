...
<div class="space-y-6" x-data="{ openAddModal: false, openEditModal: false, editData: {} }">
                    ...
                    @forelse($bukuList as $buku)
                        <tr class="hover:bg-gray-50/70 transition">
                            ...
                            <td class="py-3.5 px-5 text-right space-x-1.5">
                                ...
                                <form action="{{ route('admin.buku.delete', $buku->id) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus buku ini beserta seluruh eksemplarnya?')">
                                    @csrf
    ...
    <div x-show="openAddModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/60 backdrop-blur-sm p-4 overflow-y-auto"
         ...
         x-cloak>
        <div class="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-7 space-y-5 shadow-2xl border-2 border-gray-200 transform transition-all my-8">
