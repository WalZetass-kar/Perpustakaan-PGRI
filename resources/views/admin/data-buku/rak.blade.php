...
@section('title', 'Buku di Rak ' . $rak->kode_rak)
        ...
        <div class="pt-3 border-t border-gray-100 flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            ...
            <form action="{{ route('admin.data-buku.rak', $rak->id) }}" method="GET" class="flex items-center gap-2 flex-1">
                ...
                @if(request()->filled('search'))
                    <a href="{{ route('admin.data-buku.rak', $rak->id) }}" class="p-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-xl font-bold transition flex items-center justify-center shrink-0" title="Reset Pencarian">
