...
@section('page_heading', 'Manajemen Anggota Perpustakaan')

@section('content')
<div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
    <div class="p-5 border-b border-gray-100 flex items-center justify-between">
        <h2 class="text-base font-bold text-gray-900">Daftar Anggota Terdaftar & Hak Akses</h2>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse text-xs">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-100 text-gray-500 uppercase tracking-wider">
                    <th class="py-3 px-5 font-semibold">No. Anggota</th>
                    <th class="py-3 px-5 font-semibold">Nama Mahasiswa</th>
                    <th class="py-3 px-5 font-semibold">NIM</th>
                    <th class="py-3 px-5 font-semibold">Prodi</th>
