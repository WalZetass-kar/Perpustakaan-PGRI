        ...
        <div class="md:col-span-7 p-8 sm:p-10 flex flex-col justify-center space-y-6 relative bg-white">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-4 text-xs">
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ showPass: false }">
                            <input :type="showPass ? 'text' : 'password'" name="password" id="password_siswa" required placeholder="••••••••"
            ...
            <div x-show="roleTab === 'admin'" 
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Masukkan email Administrator atau Petugas Perpustakaan.</p>
                </div>
                ...
                <form action="{{ route('admin.login') }}" method="POST" class="space-y-4 text-xs">
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ showPassAdmin: false }">
                            <input :type="showPassAdmin ? 'text' : 'password'" name="password" id="password_admin" required placeholder="••••••••"
                                class="w-full pl-10 pr-11 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-700 focus:border-brand-700 focus:bg-white focus:outline-none font-medium text-gray-900 transition">
                            <svg class="w-4 h-4 text-gray-400 absolute left-3.5 top-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            <button type="button" @click="showPassAdmin = !showPassAdmin" class="absolute right-3.5 top-3.5 text-gray-400 hover:text-gray-700 focus:outline-none" :title="showPassAdmin ? 'Sembunyikan sandi' : 'Lihat sandi'">
                                <svg x-show="!showPassAdmin" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg x-show="showPassAdmin" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-cloak><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l18 18"/></svg>
                            </button>
                        </div>
                    </div>
